...
var oblasti = {
    centr : {
        vinnitsa :  {name : 'Вінниця', nt : '0', dt : '+6', sep : '...' , icon : 'cn'},
        dnepropetrovsk :  {name : 'Дніпро', nt : '-3', dt : '+6', sep : '...' , icon : 'xz'},
        kirovograd :         {name : 'Кропивницький', nt : '-2', dt : '+4', sep : '...' , icon : 'xz'},
        poltava :              {name : 'Полтава', nt : '-2', dt : '+4', sep : '...' , icon : 'xz'},
        cherkasy :           {name : 'Черкаси', nt : '-1', dt : '+5', sep : '...' , icon : 'xz'},
    },
    zapad : {
       lviv :                       {name : 'Львів', nt : '+3', dt : '+7', sep : '...' , icon : 'xz'},
       'ivano-frankivsk' :    {name : 'Івано- Франківськ', nt : '-2', dt : '+7', sep : '...' , icon : 'xz'},
       rivne :                 {name : 'Рівне', nt : '+3', dt : '+6', sep : '...' , icon : 'xz'},
       chernivtsy :             {name : 'Чернівці', nt : '+1', dt : '+8', sep : '...' , icon : 'xz'},       
       lutsk :                     {name : 'Луцьк', nt : '+2', dt : '+6', sep : '...' , icon : 'xz'},
       ternopol :                {name : 'Тернопіль', nt : '+2', dt : '+7', sep : '...' , icon : 'xz'},
       uzhgorod :              {name : 'Ужгород', nt : '+4', dt : '+9', sep : '...' , icon : 'sc'},      
       khmelnitsky :           {name : 'Хмельницький', nt : '0', dt : '+6', sep : '...' , icon : 'cn'},
     },
    ug : {
        odessa :       {name : 'Одесса', nt : '+3', dt : '+9', sep : '...' , icon : 'c'},
        herson :       {name : 'Херсон', nt : '-1', dt : '+8', sep : '...' , icon : 'xz'},
        simferopol :    {name : 'Сімферополь', nt : '+2', dt : '+8', sep : '...' , icon : 'xz'},
        zaporozhye : {name : 'Запоріжжя', nt : '-3', dt : '+7', sep : '...' , icon : 'xz'},
        nikolaev :      {name : 'Миколаїв', nt : '+1', dt : '+9', sep : '...' , icon : 'c'},
        yalta :           {name : 'Ялта', nt : '+7', dt : '+1', sep : '...' , icon : 'xz'},
     },
    vostok : {
        kharkiv :       {name : 'Харків', nt : '-2', dt : '+3', sep : '...' , icon : 'xz'},
        lugansk :      {name : 'Луганськ', nt : '-4', dt : '+5', sep : '...' , icon : 'xz'},
        donetsk :      {name : 'Донецьк', nt : '-4', dt : '+4', sep : '...' , icon : 'xz'},
    }, 
    sever : {
        chernihiv :     {name : 'Чернігів', nt : '0', dt : '+4', sep : '...' , icon : 'xz'},
        sumi :           {name : 'Суми', nt : '0', dt : '+4', sep : '...' , icon : 'xz'},
        zhitomir :      {name : 'Житомир', nt : '+2', dt : '+7', sep : '...' , icon : 'xz'},
    },
    kiev: {
        kiev : {name : 'Київ', nt : '+1', dt : '+7', sep : '...' , icon : 'xz'},
    },
};
// --------------------------
