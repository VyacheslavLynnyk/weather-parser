...
var oblasti = {
    centr : {
        ...
        dnepropetrovsk :  {name : 'Дніпро', nt : '-4', dt : '+1', sep : '...' , icon : 'sc'},
        kirovograd :         {name : 'Кропивницький', nt : '-4', dt : '+1', sep : '...' , icon : 'c'},
        poltava :              {name : 'Полтава', nt : '-4', dt : '0', sep : '...' , icon : 'c'},
        cherkasy :           {name : 'Черкаси', nt : '-3', dt : '+1', sep : '...' , icon : 'xz'},
    },
    zapad : {
       lviv :                       {name : 'Львів', nt : '+1', dt : '+6', sep : '...' , icon : 'sc'},
       'ivano-frankivsk' :    {name : 'Івано- Франківськ', nt : '-2', dt : '+5', sep : '...' , icon : 'c'},
       rivne :                 {name : 'Рівне', nt : '+2', dt : '+3', sep : '...' , icon : 'sc'},
       chernivtsy :             {name : 'Чернівці', nt : '0', dt : '+5', sep : '...' , icon : 'sc'},       
       lutsk :                     {name : 'Луцьк', nt : '+2', dt : '+4', sep : '...' , icon : 'c'},
       ternopol :                {name : 'Тернопіль', nt : '0', dt : '+5', sep : '...' , icon : 'c'},
       uzhgorod :              {name : 'Ужгород', nt : '+2', dt : '+1', sep : '...' , icon : 'sc'},      
       khmelnitsky :           {name : 'Хмельницький', nt : '-1', dt : '+3', sep : '...' , icon : 'sc'},
     },
    ug : {
        odessa :       {name : 'Одесса', nt : '-1', dt : '+7', sep : '...' , icon : 'c'},
        herson :       {name : 'Херсон', nt : '-2', dt : '+3', sep : '...' , icon : 'sc'},
        simferopol :    {name : 'Сімферополь', nt : '0', dt : '+4', sep : '...' , icon : 'xz'},
        zaporozhye : {name : 'Запоріжжя', nt : '-4', dt : '0', sep : '...' , icon : 'c'},
        nikolaev :      {name : 'Миколаїв', nt : '-3', dt : '+4', sep : '...' , icon : 'sc'},
        yalta :           {name : 'Ялта', nt : '+5', dt : '+9', sep : '...' , icon : 'xz'},
     },
    vostok : {
        kharkiv :       {name : 'Харків', nt : '-5', dt : '-1', sep : '...' , icon : 'sc'},
        lugansk :      {name : 'Луганськ', nt : '-3', dt : '+2', sep : '...' , icon : 'c'},
        donetsk :      {name : 'Донецьк', nt : '-4', dt : '+2', sep : '...' , icon : 'sc'},
    }, 
    sever : {
        chernihiv :     {name : 'Чернігів', nt : '-2', dt : '+2', sep : '...' , icon : 'sc'},
        sumi :           {name : 'Суми', nt : '-4', dt : '0', sep : '...' , icon : 'sc'},
        zhitomir :      {name : 'Житомир', nt : '-1', dt : '+2', sep : '...' , icon : 'sc'},
    },
    kiev: {
        kiev : {name : 'Київ', nt : '-2', dt : '+1', sep : '...' , icon : 'sc'},
    },
};
// --------------------------
