// ---- INFO ----- DATE-UPDATE: 2016-11-25 22:05;
var oblasti = {
    centr : {
        vinnitsa :  {name : 'Вінниця', nt : '-1', dt : '+2', sep : '...' , icon : 'sc'},
        dnepropetrovsk :  {name : 'Дніпро', nt : '-4', dt : '-1', sep : '...' , icon : 'c'},
        kirovograd :         {name : 'Кропивницький', nt : '-3', dt : '0', sep : '...' , icon : 'c'},
        poltava :              {name : 'Полтава', nt : '-5', dt : '-1', sep : '...' , icon : 'c'},
        cherkasy :           {name : 'Черкаси', nt : '-2', dt : '+1', sep : '...' , icon : 'cn'},
    },
    zapad : {
       lviv :                       {name : 'Львів', nt : '-2', dt : '+4', sep : '...' , icon : 'sc'},
       'ivano-frankivsk' :    {name : 'Івано- Франківськ', nt : '-1', dt : '+4', sep : '...' , icon : 'sc'},
       ...
       uzhgorod :              {name : 'Ужгород', nt : '+3', dt : '+7', sep : '...' , icon : 'sc'},      
       khmelnitsky :           {name : 'Хмельницький', nt : '-1', dt : '+2', sep : '...' , icon : 'sc'},
     },
    ug : {
        odessa :       {name : 'Одесса', nt : '+2', dt : '+7', sep : '...' , icon : 'cr'},
        herson :       {name : 'Херсон', nt : '0', dt : '+8', sep : '...' , icon : 'cr'},
        simferopol :    {name : 'Сімферополь', nt : '+2', dt : '+7', sep : '...' , icon : 'cr'},
        zaporozhye : {name : 'Запоріжжя', nt : '-3', dt : '0', sep : '...' , icon : 'cn'},
        nikolaev :      {name : 'Миколаїв', nt : '-1', dt : '+7', sep : '...' , icon : 'cr'},
        yalta :           {name : 'Ялта', nt : '+3', dt : '+9', sep : '...' , icon : 'rf'},
     },
    vostok : {
        kharkiv :       {name : 'Харків', nt : '-6', dt : '-2', sep : '...' , icon : 'sc'},
        lugansk :      {name : 'Луганськ', nt : '-4', dt : '+1', sep : '...' , icon : 'cn'},
        donetsk :      {name : 'Донецьк', nt : '-3', dt : '0', sep : '...' , icon : 'cn'},
    }, 
    sever : {
        chernihiv :     {name : 'Чернігів', nt : '+1', dt : '+2', sep : '...' , icon : 'sc'},
        sumi :           {name : 'Суми', nt : '-6', dt : '-1', sep : '...' , icon : 'c'},
        zhitomir :      {name : 'Житомир', nt : '0', dt : '+2', sep : '...' , icon : 'sc'},
    },
    kiev: {
