...
var oblasti = {
    centr : {
        vinnitsa :  {name : 'Вінниця', nt : '-1', dt : '0', sep : '...' , icon : 'sc'},
        dnepropetrovsk :  {name : 'Дніпро', nt : '-7', dt : '+1', sep : '...' , icon : 's'},
        kirovograd :         {name : 'Кропивницький', nt : '-4', dt : '0', sep : '...' , icon : 's'},
        poltava :              {name : 'Полтава', nt : '-7', dt : '0', sep : '...' , icon : 's'},
        cherkasy :           {name : 'Черкаси', nt : '-3', dt : '+1', sep : '...' , icon : 'sc'},
    },
    zapad : {
       lviv :                       {name : 'Львів', nt : '+1', dt : '+6', sep : '...' , icon : 's'},
       'ivano-frankivsk' :    {name : 'Івано- Франківськ', nt : '0', dt : '+4', sep : '...' , icon : 'sc'},
       rivne :                 {name : 'Рівне', nt : '-1', dt : '+2', sep : '...' , icon : 'sc'},
       chernivtsy :             {name : 'Чернівці', nt : '+2', dt : '+4', sep : '...' , icon : 'c'},       
       lutsk :                     {name : 'Луцьк', nt : '+1', dt : '+4', sep : '...' , icon : 'sc'},
       ternopol :                {name : 'Тернопіль', nt : '0', dt : '+2', sep : '...' , icon : 'c'},
       uzhgorod :              {name : 'Ужгород', nt : '0', dt : '+1', sep : '...' , icon : 's'},      
       khmelnitsky :           {name : 'Хмельницький', nt : '-1', dt : '+1', sep : '...' , icon : 'sc'},
     },
    ug : {
        odessa :       {name : 'Одесса', nt : '+1', dt : '+5', sep : '...' , icon : 'sc'},
        herson :       {name : 'Херсон', nt : '-1', dt : '+5', sep : '...' , icon : 's'},
        simferopol :    {name : 'Сімферополь', nt : '-3', dt : '+7', sep : '...' , icon : 's'},
        zaporozhye : {name : 'Запоріжжя', nt : '-6', dt : '+2', sep : '...' , icon : 's'},
        nikolaev :      {name : 'Миколаїв', nt : '-2', dt : '+2', sep : '...' , icon : 's'},
        yalta :           {name : 'Ялта', nt : '-3', dt : '+1', sep : '...' , icon : 's'},
     },
    vostok : {
        kharkiv :       {name : 'Харків', nt : '-7', dt : '0', sep : '...' , icon : 's'},
        lugansk :      {name : 'Луганськ', nt : '-6', dt : '-1', sep : '...' , icon : 's'},
        donetsk :      {name : 'Донецьк', nt : '-6', dt : '0', sep : '...' , icon : 's'},
    }, 
    sever : {
        chernihiv :     {name : 'Чернігів', nt : '-4', dt : '-1', sep : '...' , icon : 'sc'},
        sumi :           {name : 'Суми', nt : '-8', dt : '-2', sep : '...' , icon : 's'},
        zhitomir :      {name : 'Житомир', nt : '-1', dt : '+1', sep : '...' , icon : 'sc'},
    },
    kiev: {
        kiev : {name : 'Київ', nt : '-3', dt : '0', sep : '...' , icon : 'sc'},
    },
};
// --------------------------
