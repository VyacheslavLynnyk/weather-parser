...
var oblasti = {
    centr : {
        vinnitsa :  {name : 'Вінниця', nt : '-4', dt : '-1', sep : '...' , icon : 'c'},
        dnepropetrovsk :  {name : 'Дніпро', nt : '-7', dt : '-4', sep : '...' , icon : 'c'},
        kirovograd :         {name : 'Кропивницький', nt : '-7', dt : '-3', sep : '...' , icon : 'c'},
        poltava :              {name : 'Полтава', nt : '-8', dt : '-3', sep : '...' , icon : 'c'},
        cherkasy :           {name : 'Черкаси', nt : '-6', dt : '-2', sep : '...' , icon : 'c'},
    },
    zapad : {
       lviv :                       {name : 'Львів', nt : '-3', dt : '+1', sep : '...' , icon : 's'},
       'ivano-frankivsk' :    {name : 'Івано- Франківськ', nt : '-6', dt : '+1', sep : '...' , icon : 'c'},
       rivne :                 {name : 'Рівне', nt : '-3', dt : '+1', sep : '...' , icon : 'c'},
       chernivtsy :             {name : 'Чернівці', nt : '-5', dt : '+3', sep : '...' , icon : 'c'},       
       lutsk :                     {name : 'Луцьк', nt : '-2', dt : '+1', sep : '...' , icon : 'cr'},
       ternopol :                {name : 'Тернопіль', nt : '-4', dt : '0', sep : '...' , icon : 'c'},
       uzhgorod :              {name : 'Ужгород', nt : '-3', dt : '+2', sep : '...' , icon : 'c'},      
       khmelnitsky :           {name : 'Хмельницький', nt : '-4', dt : '-1', sep : '...' , icon : 'c'},
     },
    ug : {
        odessa :       {name : 'Одесса', nt : '-6', dt : '0', sep : '...' , icon : 'c'},
        herson :       {name : 'Херсон', nt : '-5', dt : '-1', sep : '...' , icon : 'c'},
        simferopol :    {name : 'Сімферополь', nt : '-5', dt : '0', sep : '...' , icon : 'c'},
        zaporozhye : {name : 'Запоріжжя', nt : '-7', dt : '-3', sep : '...' , icon : 'c'},
        nikolaev :      {name : 'Миколаїв', nt : '-6', dt : '-1', sep : '...' , icon : 'c'},
        yalta :           {name : 'Ялта', nt : '-3', dt : '+4', sep : '...' , icon : 'c'},
     },
    vostok : {
        kharkiv :       {name : 'Харків', nt : '-9', dt : '-4', sep : '...' , icon : 'c'},
        lugansk :      {name : 'Луганськ', nt : '-9', dt : '-3', sep : '...' , icon : 'c'},
        donetsk :      {name : 'Донецьк', nt : '-9', dt : '-3', sep : '...' , icon : 'c'},
    }, 
    sever : {
        chernihiv :     {name : 'Чернігів', nt : '-5', dt : '-2', sep : '...' , icon : 'c'},
        sumi :           {name : 'Суми', nt : '-1', dt : '-4', sep : '...' , icon : 'c'},
        zhitomir :      {name : 'Житомир', nt : '-3', dt : '+1', sep : '...' , icon : 'c'},
    },
    kiev: {
        kiev : {name : 'Київ', nt : '-4', dt : '0', sep : '...' , icon : 'c'},
    },
};
// --------------------------
