...
var oblasti = {
    centr : {
        vinnitsa :  {name : 'Вінниця', nt : '-2', dt : '+1', sep : '...' , icon : 'cn'},
        dnepropetrovsk :  {name : 'Дніпро', nt : '-1', dt : '+7', sep : '...' , icon : 'sc'},
        kirovograd :         {name : 'Кропивницький', nt : '-3', dt : '+2', sep : '...' , icon : 'sc'},
        poltava :              {name : 'Полтава', nt : '-2', dt : '+2', sep : '...' , icon : 'sc'},
        cherkasy :           {name : 'Черкаси', nt : '0', dt : '+2', sep : '...' , icon : 'sc'},
    },
    zapad : {
       lviv :                       {name : 'Львів', nt : '-3', dt : '0', sep : '...' , icon : 'cn'},
       'ivano-frankivsk' :    {name : 'Івано- Франківськ', nt : '-2', dt : '+1', sep : '...' , icon : 'cn'},
       rivne :                 {name : 'Рівне', nt : '-4', dt : '0', sep : '...' , icon : 'sc'},
       chernivtsy :             {name : 'Чернівці', nt : '-1', dt : '+2', sep : '...' , icon : 'cn'},       
       lutsk :                     {name : 'Луцьк', nt : '-3', dt : '+1', sep : '...' , icon : 'cn'},
       ternopol :                {name : 'Тернопіль', nt : '-3', dt : '0', sep : '...' , icon : 'cn'},
       uzhgorod :              {name : 'Ужгород', nt : '-1', dt : '+3', sep : '...' , icon : 'cn'},      
       khmelnitsky :           {name : 'Хмельницький', nt : '-3', dt : '+1', sep : '...' , icon : 'cn'},
     },
    ug : {
        odessa :       {name : 'Одесса', nt : '0', dt : '+5', sep : '...' , icon : 'sc'},
        herson :       {name : 'Херсон', nt : '0', dt : '+7', sep : '...' , icon : 'sc'},
        simferopol :    {name : 'Сімферополь', nt : '+4', dt : '+1', sep : '...' , icon : 'cn'},
        zaporozhye : {name : 'Запоріжжя', nt : '+1', dt : '+7', sep : '...' , icon : 'sc'},
        nikolaev :      {name : 'Миколаїв', nt : '-1', dt : '+5', sep : '...' , icon : 'sc'},
        yalta :           {name : 'Ялта', nt : '+9', dt : '+1', sep : '...' , icon : 'cn'},
     },
    vostok : {
        kharkiv :       {name : 'Харків', nt : '-2', dt : '+4', sep : '...' , icon : 'cn'},
        lugansk :      {name : 'Луганськ', nt : '+1', dt : '+8', sep : '...' , icon : 'cn'},
        donetsk :      {name : 'Донецьк', nt : '0', dt : '+7', sep : '...' , icon : 'sc'},
    }, 
    sever : {
        chernihiv :     {name : 'Чернігів', nt : '-3', dt : '+2', sep : '...' , icon : 'cn'},
        sumi :           {name : 'Суми', nt : '-3', dt : '+1', sep : '...' , icon : 'sc'},
        zhitomir :      {name : 'Житомир', nt : '-2', dt : '+1', sep : '...' , icon : 'cn'},
    },
    kiev: {
        kiev : {name : 'Київ', nt : '-2', dt : '+2', sep : '...' , icon : 'sc'},
    },
};
// --------------------------
