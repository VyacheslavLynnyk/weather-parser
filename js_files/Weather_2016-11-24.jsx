...
var oblasti = {
    centr : {
        vinnitsa :  {name : 'Вінниця', nt : '-3', dt : '+2', sep : '...' , icon : 'sc'},
        dnepropetrovsk :  {name : 'Дніпро', nt : '-6', dt : '+1', sep : '...' , icon : 'xz'},
        kirovograd :         {name : 'Кропивницький', nt : '-6', dt : '0', sep : '...' , icon : 'cn'},
        poltava :              {name : 'Полтава', nt : '-6', dt : '+1', sep : '...' , icon : 'sc'},
        cherkasy :           {name : 'Черкаси', nt : '-4', dt : '+1', sep : '...' , icon : 'xz'},
    },
    zapad : {
       lviv :                       {name : 'Львів', nt : '-1', dt : '+7', sep : '...' , icon : 'c'},
       'ivano-frankivsk' :    {name : 'Івано- Франківськ', nt : '-2', dt : '+5', sep : '...' , icon : 'sc'},
       rivne :                 {name : 'Рівне', nt : '-1', dt : '+5', sep : '...' , icon : 'xz'},
       chernivtsy :             {name : 'Чернівці', nt : '+1', dt : '+4', sep : '...' , icon : 'sc'},       
       lutsk :                     {name : 'Луцьк', nt : '0', dt : '+5', sep : '...' , icon : 'xz'},
       ternopol :                {name : 'Тернопіль', nt : '-1', dt : '+4', sep : '...' , icon : 'c'},
       uzhgorod :              {name : 'Ужгород', nt : '+1', dt : '+9', sep : '...' , icon : 'sc'},      
       khmelnitsky :           {name : 'Хмельницький', nt : '0', dt : '+2', sep : '...' , icon : 'xz'},
     },
    ug : {
        odessa :       {name : 'Одесса', nt : '-3', dt : '+3', sep : '...' , icon : 'sc'},
        herson :       {name : 'Херсон', nt : '-4', dt : '+3', sep : '...' , icon : 'sc'},
        simferopol :    {name : 'Сімферополь', nt : '-1', dt : '+5', sep : '...' , icon : 'c'},
        zaporozhye : {name : 'Запоріжжя', nt : '-6', dt : '+1', sep : '...' , icon : 'cn'},
        nikolaev :      {name : 'Миколаїв', nt : '-4', dt : '+2', sep : '...' , icon : 'sc'},
        yalta :           {name : 'Ялта', nt : '+7', dt : '+9', sep : '...' , icon : 'sc'},
     },
    vostok : {
        kharkiv :       {name : 'Харків', nt : '-6', dt : '+1', sep : '...' , icon : 'sc'},
        lugansk :      {name : 'Луганськ', nt : '-6', dt : '+3', sep : '...' , icon : 'sc'},
        donetsk :      {name : 'Донецьк', nt : '-6', dt : '+2', sep : '...' , icon : 'sc'},
    }, 
    sever : {
        chernihiv :     {name : 'Чернігів', nt : '-5', dt : '0', sep : '...' , icon : 'xz'},
        sumi :           {name : 'Суми', nt : '-7', dt : '0', sep : '...' , icon : 'c'},
        zhitomir :      {name : 'Житомир', nt : '-2', dt : '+2', sep : '...' , icon : 'xz'},
    },
    kiev: {
        kiev : {name : 'Київ', nt : '-3', dt : '+2', sep : '...' , icon : 'xz'},
    },
};
// --------------------------
