...
var oblasti = {
    centr : {
        vinnitsa :  {name : 'Вінниця', nt : '-2', dt : '+2', sep : '...' , icon : 'sc'},
        dnepropetrovsk :  {name : 'Дніпро', nt : '-5', dt : '+1', sep : '...' , icon : 's'},
        kirovograd :         {name : 'Кропивницький', nt : '-6', dt : '0', sep : '...' , icon : 's'},
        poltava :              {name : 'Полтава', nt : '-6', dt : '0', sep : '...' , icon : 's'},
        cherkasy :           {name : 'Черкаси', nt : '-3', dt : '0', sep : '...' , icon : 's'},
    },
    zapad : {
       lviv :                       {name : 'Львів', nt : '0', dt : '+6', sep : '...' , icon : 'sc'},
       'ivano-frankivsk' :    {name : 'Івано- Франківськ', nt : '-1', dt : '+5', sep : '...' , icon : 'sc'},
       rivne :                 {name : 'Рівне', nt : '0', dt : '+4', sep : '...' , icon : 'sc'},
       chernivtsy :             {name : 'Чернівці', nt : '+1', dt : '+5', sep : '...' , icon : 'sc'},       
       lutsk :                     {name : 'Луцьк', nt : '0', dt : '+5', sep : '...' , icon : 'sc'},
       ternopol :                {name : 'Тернопіль', nt : '-1', dt : '+3', sep : '...' , icon : 'sc'},
       uzhgorod :              {name : 'Ужгород', nt : '+2', dt : '+1', sep : '...' , icon : 'sc'},      
       khmelnitsky :           {name : 'Хмельницький', nt : '0', dt : '+3', sep : '...' , icon : 'sc'},
     },
    ug : {
        odessa :       {name : 'Одесса', nt : '-3', dt : '+2', sep : '...' , icon : 's'},
        herson :       {name : 'Херсон', nt : '-3', dt : '+2', sep : '...' , icon : 's'},
        simferopol :    {name : 'Сімферополь', nt : '-2', dt : '+4', sep : '...' , icon : 's'},
        zaporozhye : {name : 'Запоріжжя', nt : '-5', dt : '+1', sep : '...' , icon : 's'},
        nikolaev :      {name : 'Миколаїв', nt : '-3', dt : '+1', sep : '...' , icon : 's'},
        yalta :           {name : 'Ялта', nt : '+7', dt : '+1', sep : '...' , icon : 's'},
     },
    vostok : {
        kharkiv :       {name : 'Харків', nt : '-6', dt : '-1', sep : '...' , icon : 's'},
        lugansk :      {name : 'Луганськ', nt : '-8', dt : '-1', sep : '...' , icon : 's'},
        donetsk :      {name : 'Донецьк', nt : '-7', dt : '+1', sep : '...' , icon : 's'},
    }, 
    sever : {
        chernihiv :     {name : 'Чернігів', nt : '-3', dt : '0', sep : '...' , icon : 's'},
        sumi :           {name : 'Суми', nt : '-7', dt : '-3', sep : '...' , icon : 's'},
        zhitomir :      {name : 'Житомир', nt : '-2', dt : '+2', sep : '...' , icon : 'sc'},
    },
    kiev: {
        kiev : {name : 'Київ', nt : '-3', dt : '+1', sep : '...' , icon : 's'},
    },
};
// --------------------------
