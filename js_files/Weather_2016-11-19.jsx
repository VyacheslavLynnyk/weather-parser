...
var oblasti = {
    centr : {
        vinnitsa :  {name : 'Вінниця', nt : '+3', dt : '+7', sep : '...' , icon : 'sc'},
        dnepropetrovsk :  {name : 'Дніпро', nt : '-1', dt : '+4', sep : '...' , icon : 'sc'},
        kirovograd :         {name : 'Кропивницький', nt : '+1', dt : '+6', sep : '...' , icon : 'sc'},
        poltava :              {name : 'Полтава', nt : '0', dt : '+4', sep : '...' , icon : 's'},
        cherkasy :           {name : 'Черкаси', nt : '+2', dt : '+7', sep : '...' , icon : 'sc'},
    },
    zapad : {
       lviv :                       {name : 'Львів', nt : '+4', dt : '+9', sep : '...' , icon : 'sc'},
       'ivano-frankivsk' :    {name : 'Івано- Франківськ', nt : '-1', dt : '+7', sep : '...' , icon : 'sc'},
       rivne :                 {name : 'Рівне', nt : '+3', dt : '+6', sep : '...' , icon : 'sc'},
       chernivtsy :             {name : 'Чернівці', nt : '0', dt : '+6', sep : '...' , icon : 'sc'},       
       lutsk :                     {name : 'Луцьк', nt : '+4', dt : '+7', sep : '...' , icon : 'sc'},
       ternopol :                {name : 'Тернопіль', nt : '0', dt : '+4', sep : '...' , icon : 'c'},
       uzhgorod :              {name : 'Ужгород', nt : '+8', dt : '+1', sep : '...' , icon : 'sc'},      
       khmelnitsky :           {name : 'Хмельницький', nt : '+2', dt : '+6', sep : '...' , icon : 'c'},
     },
    ug : {
        odessa :       {name : 'Одесса', nt : '+6', dt : '+1', sep : '...' , icon : 's'},
        herson :       {name : 'Херсон', nt : '+2', dt : '+7', sep : '...' , icon : 's'},
        simferopol :    {name : 'Сімферополь', nt : '+1', dt : '+1', sep : '...' , icon : 's'},
        zaporozhye : {name : 'Запоріжжя', nt : '-2', dt : '+4', sep : '...' , icon : 'sc'},
        nikolaev :      {name : 'Миколаїв', nt : '+2', dt : '+8', sep : '...' , icon : 's'},
        yalta :           {name : 'Ялта', nt : '+6', dt : '+1', sep : '...' , icon : 's'},
     },
    vostok : {
        kharkiv :       {name : 'Харків', nt : '-2', dt : '+2', sep : '...' , icon : 's'},
        lugansk :      {name : 'Луганськ', nt : '-4', dt : '+1', sep : '...' , icon : 'sc'},
        donetsk :      {name : 'Донецьк', nt : '-4', dt : '+1', sep : '...' , icon : 'c'},
    }, 
    sever : {
        chernihiv :     {name : 'Чернігів', nt : '+4', dt : '+6', sep : '...' , icon : 'sc'},
        sumi :           {name : 'Суми', nt : '0', dt : '+3', sep : '...' , icon : 'sc'},
        zhitomir :      {name : 'Житомир', nt : '+2', dt : '+6', sep : '...' , icon : 'sc'},
    },
    kiev: {
        kiev : {name : 'Київ', nt : '+4', dt : '+7', sep : '...' , icon : 's'},
    },
};
// --------------------------
