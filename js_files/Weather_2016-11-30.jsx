...
var oblasti = {
    centr : {
        vinnitsa :  {name : 'Вінниця', nt : '-7', dt : '0', sep : '...' , icon : 'cn'},
        dnepropetrovsk :  {name : 'Дніпро', nt : '-6', dt : '-3', sep : '...' , icon : 'cn'},
        kirovograd :         {name : 'Кропивницький', nt : '-7', dt : '-1', sep : '...' , icon : 'cn'},
        poltava :              {name : 'Полтава', nt : '-8', dt : '-3', sep : '...' , icon : 'cn'},
        cherkasy :           {name : 'Черкаси', nt : '-6', dt : '0', sep : '...' , icon : 'cn'},
    },
    zapad : {
       lviv :                       {name : 'Львів', nt : '-5', dt : '0', sep : '...' , icon : 'cn'},
       'ivano-frankivsk' :    {name : 'Івано- Франківськ', nt : '-2', dt : '+2', sep : '...' , icon : 'cn'},
       rivne :                 {name : 'Рівне', nt : '-4', dt : '-1', sep : '...' , icon : 'cn'},
       chernivtsy :             {name : 'Чернівці', nt : '-3', dt : '+1', sep : '...' , icon : 'sc'},       
       lutsk :                     {name : 'Луцьк', nt : '-5', dt : '+1', sep : '...' , icon : 'cn'},
       ternopol :                {name : 'Тернопіль', nt : '-4', dt : '0', sep : '...' , icon : 'cn'},
       uzhgorod :              {name : 'Ужгород', nt : '-2', dt : '+1', sep : '...' , icon : 'cn'},      
       khmelnitsky :           {name : 'Хмельницький', nt : '-3', dt : '0', sep : '...' , icon : 'cn'},
     },
    ug : {
        odessa :       {name : 'Одесса', nt : '-6', dt : '+2', sep : '...' , icon : 'sc'},
        herson :       {name : 'Херсон', nt : '-5', dt : '0', sep : '...' , icon : 'sc'},
        simferopol :    {name : 'Сімферополь', nt : '-6', dt : '-2', sep : '...' , icon : 'cn'},
        zaporozhye : {name : 'Запоріжжя', nt : '-6', dt : '-2', sep : '...' , icon : 'cn'},
        nikolaev :      {name : 'Миколаїв', nt : '-5', dt : '0', sep : '...' , icon : 'sc'},
        yalta :           {name : 'Ялта', nt : '-2', dt : '+3', sep : '...' , icon : 'cn'},
     },
    vostok : {
        kharkiv :       {name : 'Харків', nt : '-8', dt : '-6', sep : '...' , icon : 'cn'},
        lugansk :      {name : 'Луганськ', nt : '-7', dt : '-3', sep : '...' , icon : 'sc'},
        donetsk :      {name : 'Донецьк', nt : '-7', dt : '-3', sep : '...' , icon : 'cn'},
    }, 
    sever : {
        chernihiv :     {name : 'Чернігів', nt : '-7', dt : '-1', sep : '...' , icon : 'cn'},
        sumi :           {name : 'Суми', nt : '-9', dt : '-6', sep : '...' , icon : 'cn'},
        zhitomir :      {name : 'Житомир', nt : '-7', dt : '0', sep : '...' , icon : 'cn'},
    },
    kiev: {
        kiev : {name : 'Київ', nt : '-7', dt : '+1', sep : '...' , icon : 'cn'},
    },
};
// --------------------------
