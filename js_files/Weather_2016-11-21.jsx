...
var oblasti = {
    centr : {
        ...
        dnepropetrovsk :  {name : 'Дніпро', nt : '-2', dt : '+4', sep : '...' , icon : 'sc'},
        kirovograd :         {name : 'Кропивницький', nt : '0', dt : '+4', sep : '...' , icon : 'sc'},
        poltava :              {name : 'Полтава', nt : '-3', dt : '+3', sep : '...' , icon : 'sc'},
        cherkasy :           {name : 'Черкаси', nt : '0', dt : '+3', sep : '...' , icon : 'sc'},
    },
    zapad : {
       lviv :                       {name : 'Львів', nt : '+3', dt : '+8', sep : '...' , icon : 'sc'},
       'ivano-frankivsk' :    {name : 'Івано- Франківськ', nt : '+1', dt : '+8', sep : '...' , icon : 'sc'},
       rivne :                 {name : 'Рівне', nt : '+1', dt : '+5', sep : '...' , icon : 'sc'},
       chernivtsy :             {name : 'Чернівці', nt : '+3', dt : '+6', sep : '...' , icon : 'sc'},       
       lutsk :                     {name : 'Луцьк', nt : '+2', dt : '+7', sep : '...' , icon : 'sc'},
       ternopol :                {name : 'Тернопіль', nt : '+1', dt : '+4', sep : '...' , icon : 'c'},
       uzhgorod :              {name : 'Ужгород', nt : '+6', dt : '+1', sep : '...' , icon : 's'},      
       khmelnitsky :           {name : 'Хмельницький', nt : '+1', dt : '+5', sep : '...' , icon : 'sc'},
     },
    ug : {
        odessa :       {name : 'Одесса', nt : '+4', dt : '+6', sep : '...' , icon : 'sc'},
        herson :       {name : 'Херсон', nt : '+2', dt : '+7', sep : '...' , icon : 'sc'},
        simferopol :    {name : 'Сімферополь', nt : '-2', dt : '+1', sep : '...' , icon : 's'},
    ...
    vostok : {
        ...
        lugansk :      {name : 'Луганськ', nt : '-5', dt : '0', sep : '...' , icon : 'sc'},
        donetsk :      {name : 'Донецьк', nt : '-4', dt : '+1', sep : '...' , icon : 'sc'},
    }, 
    sever : {
        chernihiv :     {name : 'Чернігів', nt : '-2', dt : '+2', sep : '...' , icon : 's'},
        sumi :           {name : 'Суми', nt : '-3', dt : '+1', sep : '...' , icon : 'sc'},
        zhitomir :      {name : 'Житомир', nt : '-1', dt : '+2', sep : '...' , icon : 'sc'},
    },
    kiev: {
        kiev : {name : 'Київ', nt : '-1', dt : '+2', sep : '...' , icon : 's'},
    },
};
// --------------------------
