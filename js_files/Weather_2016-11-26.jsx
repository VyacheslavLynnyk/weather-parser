...
var oblasti = {
    centr : {
        vinnitsa :  {name : 'Вінниця', nt : '-3', dt : '+1', sep : '...' , icon : 'sc'},
        dnepropetrovsk :  {name : 'Дніпро', nt : '-3', dt : '-1', sep : '...' , icon : 'c'},
        kirovograd :         {name : 'Кропивницький', nt : '-3', dt : '0', sep : '...' , icon : 'c'},
        poltava :              {name : 'Полтава', nt : '-3', dt : '0', sep : '...' , icon : 'xz'},
        cherkasy :           {name : 'Черкаси', nt : '-2', dt : '0', sep : '...' , icon : 'xz'},
    },
    zapad : {
       lviv :                       {name : 'Львів', nt : '+2', dt : '+6', sep : '...' , icon : 'xz'},
       'ivano-frankivsk' :    {name : 'Івано- Франківськ', nt : '-1', dt : '+5', sep : '...' , icon : 'xz'},
       rivne :                 {name : 'Рівне', nt : '-1', dt : '+4', sep : '...' , icon : 'xz'},
       chernivtsy :             {name : 'Чернівці', nt : '0', dt : '+4', sep : '...' , icon : 'sc'},       
       lutsk :                     {name : 'Луцьк', nt : '+1', dt : '+4', sep : '...' , icon : 'xz'},
       ternopol :                {name : 'Тернопіль', nt : '+1', dt : '+4', sep : '...' , icon : 'xz'},
       uzhgorod :              {name : 'Ужгород', nt : '+3', dt : '+1', sep : '...' , icon : 'xz'},      
       khmelnitsky :           {name : 'Хмельницький', nt : '-3', dt : '+2', sep : '...' , icon : 'c'},
     },
    ug : {
        odessa :       {name : 'Одесса', nt : '0', dt : '+3', sep : '...' , icon : 'c'},
        herson :       {name : 'Херсон', nt : '-2', dt : '+1', sep : '...' , icon : 'sc'},
        simferopol :    {name : 'Сімферополь', nt : '+3', dt : '+7', sep : '...' , icon : 'sc'},
        zaporozhye : {name : 'Запоріжжя', nt : '-3', dt : '-1', sep : '...' , icon : 'c'},
        nikolaev :      {name : 'Миколаїв', nt : '-1', dt : '+1', sep : '...' , icon : 'c'},
        yalta :           {name : 'Ялта', nt : '+5', dt : '+1', sep : '...' , icon : 'sc'},
     },
    vostok : {
        kharkiv :       {name : 'Харків', nt : '-2', dt : '0', sep : '...' , icon : 'xz'},
        lugansk :      {name : 'Луганськ', nt : '-3', dt : '0', sep : '...' , icon : 'xz'},
        donetsk :      {name : 'Донецьк', nt : '-4', dt : '0', sep : '...' , icon : 'sc'},
    }, 
    sever : {
        chernihiv :     {name : 'Чернігів', nt : '-1', dt : '0', sep : '...' , icon : 'xz'},
        sumi :           {name : 'Суми', nt : '-2', dt : '0', sep : '...' , icon : 'xz'},
        zhitomir :      {name : 'Житомир', nt : '-3', dt : '+1', sep : '...' , icon : 'xz'},
    },
    kiev: {
        kiev : {name : 'Київ', nt : '-2', dt : '0', sep : '...' , icon : 'xz'},
    },
};
// --------------------------
