...
var oblasti = {
    centr : {
        vinnitsa :  {name : 'Вінниця', nt : '-1', dt : '+3', sep : '...' , icon : 'cn'},
        dnepropetrovsk :  {name : 'Дніпро', nt : '-3', dt : '+1', sep : '...' , icon : 'cn'},
        kirovograd :         {name : 'Кропивницький', nt : '-2', dt : '+2', sep : '...' , icon : 'cn'},
        poltava :              {name : 'Полтава', nt : '-2', dt : '0', sep : '...' , icon : 'rf'},
        cherkasy :           {name : 'Черкаси', nt : '0', dt : '+3', sep : '...' , icon : 'cr'},
    },
    zapad : {
       lviv :                       {name : 'Львів', nt : '-1', dt : '+5', sep : '...' , icon : 'cn'},
       'ivano-frankivsk' :    {name : 'Івано- Франківськ', nt : '-1', dt : '+5', sep : '...' , icon : 'cn'},
       rivne :                 {name : 'Рівне', nt : '-2', dt : '+4', sep : '...' , icon : 'sc'},
       chernivtsy :             {name : 'Чернівці', nt : '0', dt : '+2', sep : '...' , icon : 'rf'},       
       lutsk :                     {name : 'Луцьк', nt : '-2', dt : '+4', sep : '...' , icon : 'cn'},
       ternopol :                {name : 'Тернопіль', nt : '-1', dt : '+3', sep : '...' , icon : 'cn'},
       uzhgorod :              {name : 'Ужгород', nt : '-3', dt : '+8', sep : '...' , icon : 'cn'},      
       khmelnitsky :           {name : 'Хмельницький', nt : '-1', dt : '+3', sep : '...' , icon : 'cn'},
     },
    ug : {
        odessa :       {name : 'Одесса', nt : '+1', dt : '+3', sep : '...' , icon : 'cr'},
        herson :       {name : 'Херсон', nt : '+1', dt : '+2', sep : '...' , icon : 'cn'},
        simferopol :    {name : 'Сімферополь', nt : '+1', dt : '+7', sep : '...' , icon : 'sc'},
        zaporozhye : {name : 'Запоріжжя', nt : '-2', dt : '+1', sep : '...' , icon : 'cr'},
        nikolaev :      {name : 'Миколаїв', nt : '0', dt : '+2', sep : '...' , icon : 'c'},
        yalta :           {name : 'Ялта', nt : '+1', dt : '+9', sep : '...' , icon : 'rf'},
     },
    vostok : {
        kharkiv :       {name : 'Харків', nt : '-2', dt : '+1', sep : '...' , icon : 'rf'},
        lugansk :      {name : 'Луганськ', nt : '-4', dt : '+1', sep : '...' , icon : 'sc'},
        donetsk :      {name : 'Донецьк', nt : '-4', dt : '0', sep : '...' , icon : 'sc'},
    }, 
    sever : {
        chernihiv :     {name : 'Чернігів', nt : '+1', dt : '+2', sep : '...' , icon : 'c'},
        sumi :           {name : 'Суми', nt : '-1', dt : '0', sep : '...' , icon : 'cr'},
        zhitomir :      {name : 'Житомир', nt : '-1', dt : '+2', sep : '...' , icon : 'c'},
    },
    kiev: {
