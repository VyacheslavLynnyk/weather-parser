...
var oblasti = {
    centr : {
        vinnitsa :  {name : 'Вінниця', nt : '-1', dt : '+1', sep : '...' , icon : 'cr'},
        dnepropetrovsk :  {name : 'Дніпро', nt : '-3', dt : '-1', sep : '...' , icon : 'cr'},
        kirovograd :         {name : 'Кропивницький', nt : '-2', dt : '0', sep : '...' , icon : 'cr'},
        poltava :              {name : 'Полтава', nt : '-3', dt : '0', sep : '...' , icon : 'c'},
        cherkasy :           {name : 'Черкаси', nt : '-1', dt : '+1', sep : '...' , icon : 'cr'},
    },
    zapad : {
       lviv :                       {name : 'Львів', nt : '-1', dt : '+5', sep : '...' , icon : 'c'},
       'ivano-frankivsk' :    {name : 'Івано- Франківськ', nt : '-2', dt : '+2', sep : '...' , icon : 'rf'},
       rivne :                 {name : 'Рівне', nt : '-2', dt : '+2', sep : '...' , icon : 'sc'},
       chernivtsy :             {name : 'Чернівці', nt : '0', dt : '+3', sep : '...' , icon : 'cr'},       
       lutsk :                     {name : 'Луцьк', nt : '0', dt : '+3', sep : '...' , icon : 'sc'},
       ternopol :                {name : 'Тернопіль', nt : '-1', dt : '+1', sep : '...' , icon : 'cr'},
       uzhgorod :              {name : 'Ужгород', nt : '-2', dt : '+8', sep : '...' , icon : 'cr'},      
       khmelnitsky :           {name : 'Хмельницький', nt : '-2', dt : '+1', sep : '...' , icon : 'cr'},
     },
    ug : {
        odessa :       {name : 'Одесса', nt : '-1', dt : '+2', sep : '...' , icon : 'c'},
        herson :       {name : 'Херсон', nt : '0', dt : '+2', sep : '...' , icon : 'c'},
        simferopol :    {name : 'Сімферополь', nt : '+4', dt : '+7', sep : '...' , icon : 'sc'},
        zaporozhye : {name : 'Запоріжжя', nt : '-2', dt : '-1', sep : '...' , icon : 'cr'},
        nikolaev :      {name : 'Миколаїв', nt : '-1', dt : '+1', sep : '...' , icon : 'c'},
        yalta :           {name : 'Ялта', nt : '+7', dt : '+1', sep : '...' , icon : 'cr'},
     },
    vostok : {
        kharkiv :       {name : 'Харків', nt : '-2', dt : '+1', sep : '...' , icon : 'c'},
        lugansk :      {name : 'Луганськ', nt : '-2', dt : '0', sep : '...' , icon : 'sc'},
        donetsk :      {name : 'Донецьк', nt : '-3', dt : '0', sep : '...' , icon : 'c'},
    }, 
    sever : {
        chernihiv :     {name : 'Чернігів', nt : '-1', dt : '+3', sep : '...' , icon : 'cr'},
        sumi :           {name : 'Суми', nt : '-3', dt : '0', sep : '...' , icon : 'c'},
        zhitomir :      {name : 'Житомир', nt : '-2', dt : '+1', sep : '...' , icon : 'c'},
    },
    kiev: {
        kiev : {name : 'Київ', nt : '-1', dt : '+2', sep : '...' , icon : 'c'},
    },
};
// --------------------------
