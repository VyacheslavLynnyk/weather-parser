...
var oblasti = {
    centr : {
        vinnitsa :  {name : 'Вінниця', nt : '-6', dt : '-2', sep : '...' , icon : 'cn'},
        dnepropetrovsk :  {name : 'Дніпро', nt : '-5', dt : '-1', sep : '...' , icon : 's'},
        kirovograd :         {name : 'Кропивницький', nt : '-6', dt : '-1', sep : '...' , icon : 'sc'},
        poltava :              {name : 'Полтава', nt : '-5', dt : '-2', sep : '...' , icon : 's'},
        cherkasy :           {name : 'Черкаси', nt : '-4', dt : '-1', sep : '...' , icon : 'sc'},
    },
    zapad : {
       lviv :                       {name : 'Львів', nt : '-4', dt : '-1', sep : '...' , icon : 'cn'},
       'ivano-frankivsk' :    {name : 'Івано- Франківськ', nt : '-4', dt : '-1', sep : '...' , icon : 'cn'},
       rivne :                 {name : 'Рівне', nt : '-6', dt : '-4', sep : '...' , icon : 'cn'},
       chernivtsy :             {name : 'Чернівці', nt : '-3', dt : '-1', sep : '...' , icon : 'cn'},       
       lutsk :                     {name : 'Луцьк', nt : '-4', dt : '-2', sep : '...' , icon : 'cn'},
       ternopol :                {name : 'Тернопіль', nt : '-4', dt : '-2', sep : '...' , icon : 'cn'},
       uzhgorod :              {name : 'Ужгород', nt : '-3', dt : '+2', sep : '...' , icon : 'sc'},      
       khmelnitsky :           {name : 'Хмельницький', nt : '-5', dt : '-2', sep : '...' , icon : 'cn'},
     },
    ug : {
        odessa :       {name : 'Одесса', nt : '-3', dt : '0', sep : '...' , icon : 'sc'},
        herson :       {name : 'Херсон', nt : '-2', dt : '0', sep : '...' , icon : 's'},
        simferopol :    {name : 'Сімферополь', nt : '-1', dt : '+3', sep : '...' , icon : 's'},
        zaporozhye : {name : 'Запоріжжя', nt : '-3', dt : '0', sep : '...' , icon : 's'},
        nikolaev :      {name : 'Миколаїв', nt : '-2', dt : '0', sep : '...' , icon : 'sc'},
        yalta :           {name : 'Ялта', nt : '+3', dt : '+6', sep : '...' , icon : 's'},
     },
    vostok : {
        kharkiv :       {name : 'Харків', nt : '-4', dt : '-2', sep : '...' , icon : 's'},
        lugansk :      {name : 'Луганськ', nt : '-2', dt : '+1', sep : '...' , icon : 'cn'},
        donetsk :      {name : 'Донецьк', nt : '-3', dt : '+1', sep : '...' , icon : 's'},
    }, 
    sever : {
        chernihiv :     {name : 'Чернігів', nt : '-6', dt : '-4', sep : '...' , icon : 'cn'},
        sumi :           {name : 'Суми', nt : '-7', dt : '-4', sep : '...' , icon : 'sc'},
        zhitomir :      {name : 'Житомир', nt : '-6', dt : '-3', sep : '...' , icon : 'cn'},
    },
    kiev: {
        kiev : {name : 'Київ', nt : '-5', dt : '-3', sep : '...' , icon : 'cn'},
    },
};
// --------------------------
