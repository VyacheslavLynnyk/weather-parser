...
var oblasti = {
    centr : {
        vinnitsa :  {name : 'Вінниця', nt : '-5', dt : '-3', sep : '...' , icon : 'sc'},
        dnepropetrovsk :  {name : 'Дніпро', nt : '-3', dt : '-2', sep : '...' , icon : 'sc'},
        kirovograd :         {name : 'Кропивницький', nt : '-4', dt : '-3', sep : '...' , icon : 'sc'},
        poltava :              {name : 'Полтава', nt : '-5', dt : '-3', sep : '...' , icon : 'sc'},
        cherkasy :           {name : 'Черкаси', nt : '-3', dt : '-2', sep : '...' , icon : 'sc'},
    },
    zapad : {
       lviv :                       {name : 'Львів', nt : '-5', dt : '-3', sep : '...' , icon : 'cn'},
       'ivano-frankivsk' :    {name : 'Івано- Франківськ', nt : '-6', dt : '-2', sep : '...' , icon : 'sc'},
       rivne :                 {name : 'Рівне', nt : '-6', dt : '-4', sep : '...' , icon : 'c'},
       chernivtsy :             {name : 'Чернівці', nt : '-3', dt : '-2', sep : '...' , icon : 'sc'},       
       lutsk :                     {name : 'Луцьк', nt : '-4', dt : '-3', sep : '...' , icon : 'cn'},
       ternopol :                {name : 'Тернопіль', nt : '-5', dt : '-4', sep : '...' , icon : 'c'},
       uzhgorod :              {name : 'Ужгород', nt : '-4', dt : '+1', sep : '...' , icon : 'sc'},      
       khmelnitsky :           {name : 'Хмельницький', nt : '-6', dt : '-4', sep : '...' , icon : 'sc'},
     },
    ug : {
        odessa :       {name : 'Одесса', nt : '-3', dt : '-1', sep : '...' , icon : 's'},
        herson :       {name : 'Херсон', nt : '-2', dt : '-1', sep : '...' , icon : 's'},
        simferopol :    {name : 'Сімферополь', nt : '+1', dt : '+3', sep : '...' , icon : 'cn'},
        zaporozhye : {name : 'Запоріжжя', nt : '-3', dt : '-2', sep : '...' , icon : 'sc'},
        nikolaev :      {name : 'Миколаїв', nt : '-2', dt : '-1', sep : '...' , icon : 's'},
        yalta :           {name : 'Ялта', nt : '+5', dt : '+8', sep : '...' , icon : 'cn'},
     },
    vostok : {
        kharkiv :       {name : 'Харків', nt : '-5', dt : '-2', sep : '...' , icon : 'sc'},
        lugansk :      {name : 'Луганськ', nt : '-2', dt : '0', sep : '...' , icon : 'sc'},
        donetsk :      {name : 'Донецьк', nt : '-3', dt : '0', sep : '...' , icon : 'sc'},
    }, 
    sever : {
        chernihiv :     {name : 'Чернігів', nt : '-5', dt : '-2', sep : '...' , icon : 'sc'},
        sumi :           {name : 'Суми', nt : '-5', dt : '-3', sep : '...' , icon : 'sc'},
        zhitomir :      {name : 'Житомир', nt : '-4', dt : '-3', sep : '...' , icon : 'sc'},
    },
    kiev: {
        kiev : {name : 'Київ', nt : '-4', dt : '-3', sep : '...' , icon : 'sc'},
    },
};
// --------------------------
